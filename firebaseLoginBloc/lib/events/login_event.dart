...
// tham số ddầu vào là nd email mà mình gõ, cứ mỗi lần gõ thì sẽ sinh ra 1 event như vậy
...
//event khi bấm vào có hai tham số là email và pass
class LoginEventWithEmailAndPasswordPressed extends LoginEvent {
  ...
  @override
  // thể hiện thông tin chi tiết của đối tượng vào đây
